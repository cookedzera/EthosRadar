...
export function NextRankProgress({ currentScore, userkey, className = '' }: NextRankProgressProps) {
  ...
  return (
    <div className={`bg-gray-100/90 rounded-2xl p-2 shadow-md border-0 ${className}`}>
      {/* Header Row */}
      ...
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1">
          <div className={`w-4 h-4 rounded ${currentTier.bgColor} flex items-center justify-center`}>
            <CurrentIcon className="w-2 h-2 text-white" />
          </div>
          <div className="text-xs">
            <div className="font-medium text-gray-600 leading-none">{currentTier.tier}</div>
            <div className="text-gray-500 text-xs leading-none">{currentScore} pts</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1">
          <div className="text-xs text-right">
            <div className="font-medium text-gray-600 leading-none">{nextTier.tier}</div>
            <div className="text-gray-500 text-xs leading-none">{nextTier.threshold} pts</div>
          </div>
          <div className={`w-4 h-4 rounded ${nextTier.bgColor} flex items-center justify-center`}>
            <NextIcon className="w-2 h-2 text-white" />
          </div>
        </div>
      </div>
